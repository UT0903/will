      ...
      return (
        ...
        //   </p>
          <div className="container-fluid mt-5 text-center">
              <h1 style={{fontFamily:"Microsoft JhengHei"}}>建立遺產分配合約</h1>
                  ...
                  <div className="content mr-auto ml-auto">
                    <div>
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <br></br>
                            <button type="submit" className="button">建立</button>   
                            </form>
                        <br></br>       
                        <br></br>
                        <br></br>
